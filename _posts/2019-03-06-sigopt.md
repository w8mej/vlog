...
image: /images/2019/sigopt.jpg   # full-bleed hero, 16:7
image_alt: "Machine learning hyperparameter optimization landscape for security anomaly detection and SIEM tuning"
takeaways:
  - "SIEM alert thresholds require continuous algorithmic optimization to minimize false positives."
  - "Hyperparameter tuning in security ML models balances precision against recall in threat detection."
  - "Static alert thresholds decay rapidly as normal baseline network traffic patterns shift."
date: 2019-03-06
